...
const ArticulosWeb = ({ route }) => {
  ...
  const buscarAdaptarFiltrar = async (search) =>{
    const obtenerPrecio = async (articulo)=>{
      let costo = articulo.precioCosto || 0;
      let iva = articulo.porcentajeIVA1 || 0;
      let costoIva = costo * (1+ iva/100);
      let ganancia = 0;
      switch (listaDePrecios) {
        case "1": ganancia = articulo.lista1 || 0; break;
        case "2": ganancia = articulo.lista2 || 0; break;
        case "3": ganancia = articulo.lista3 || 0; break;
        case "4": ganancia = articulo.lista4 || 0; break;
        case "5": ganancia = articulo.lista5 || 0; break;
        default: return 0;
      }
